...
Sub Run_the_Screenshot()
    ...
    Const WS_NAME    As String = "Timeline in Jul"   ' ? Change if needed
    ...
    Const DAYOFF_ROW As Long = 94                   ' Row with dayoff counts
    ...
    If supervisors.Count = 0 Then
        MsgBox "No supervisors found in column F (rows 6-91).", vbExclamation
        Exit Sub
    End If
    ...
    For i = 1 To UBound(supArray)
        ...
        ' --- 7. Take screenshot ---
        Set captureRange = ws.Range("A2:AY112")
